...
switch (toLower(_role)) do {
	...
	case "fac": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_pistol_mag,2],[_grenade,2],[_smokegrenadeY,6]] call _addToUniform;
		[[_rifle_mag_tr,3],[_smokegrenadeB,6],[_smokegrenadeB,2],[_smokegrenadeP,2]] call _addToVest;
	...
	case "sl": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_grenade,2],[_flashBang,2],[_pistol_mag,2],[_smokegrenadeY,4],[_smokegrenadeB,3]] call _addToUniform;
		[[_grenade,2],[_rifleGL_mag_tr,4],[_glHE,7],[_glsmokeR,5]] call _addToVest;
	...
	case "sm": {
		...
		[[_smokegrenadeB,3],[_grenade,2],[_rifle_mag_tr,2]] call _addToVest;
	...
	case "ftl": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_flashBang,3],[_smokegrenadeB,3],[_pistol_mag,2],[_smokegrenadeY,4]] call _addToUniform;
	...
	case "g": {
		...
		[[_glHE,7],[_glsmokeR,3],[_glsmokeY,3],[_clacker,1],[_demoCharge,2],[_rifleGL_mag_tr,2]] call _addToBackpack;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
			[[_mapFlashLight,1],[_IRStrobe,1]] call _addToUniform;
	...
	case "lr": {
		...
		[[_rifleL_mag,4],[_pistol_mag,2],[_smokegrenadeY,3],[_flashBang,3]] call _addToUniform;
	...
	case "ab": {
		...
		[[_flashBang,2],[_rifleGL_mag_tr,4],[_pistol_mag,2],[_smokegrenadeY,3]] call _addToUniform;
		[[_grenade,2],[_rifleC_mag,3],[_rifleC_mag_tr,3]] call _addToVest;
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_rifle_mag_tr,5],[_LMG_mag_tr,3],[_rifleL_mag_tr,5]] call _addToBackpack;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
			[[_mapFlashLight,1],[_handFlareG,1]] call _addToUniform;
	...
	case "p": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_smokegrenadeY,2],[_smokegrenadeP,3],[_grenade,1]] call _addToUniform;
	...
	case "amat": {
		...
		_IFAK call _addToUniform;
		[[_pistol_mag,2],[_smokegrenadeY,3]] call _addToUniform;
		[[_grenade,2],[_grenade,2],[_rifle_mag_tr,6],[_glHE,6],[_glsmokeR,3]] call _addToVest;
	...
	case "ammg": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_smokegrenadeY,4],[_grenade,2]] call _addToUniform;
	...
	case "mmg": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_pistol_mag,2],[_smokegrenadeY,2],[_grenade,2]] call _addToUniform;
