...
switch (toLower(_role)) do {
	...
	case "pl": {
		...
		[[_flashBang,3],[_smokegrenadeB,5],[_grenademini,2],[_rifle_mag_tr,5]] call _addToVest;
		[[_smokegrenadeB,5]] call _addToBackpack;
		_rangefinder call _addBino;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
	...
	case "fac": {
		...
		[[_flashBang,3],[_battery,1],[_glsmokeR,5],[_glsmokeG,2],[_smokegrenadeB,5],["42cdo_vs17_item",5]] call _addToBackpack;
	...
	case "sl": {
		...
		[[_smokegrenadeB,3],[_grenademini,2],[_grenade,2],[_rifleGL_mag_tr,4],[_glHE,7]] call _addToVest;
		[[_flashBang,3],[_rifleGL_mag,4]] call _addToBackpack;
		_rangefinder call _addBino;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;

		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
			[[_mapFlashLight,1],[_IRStrobe,1],[_handFlareG,3],[_glFlareG,2]] call _addToUniform;
			[[_glFlareR,5],[_glFlareW,5],[_glsmokeR,5]] call _addToBackpack;
		};
	};
	...
	case "sm": {
		...
		_IFAK call _addToUniform;
		[[_pistol_mag,2],[_smokegrenadeY,4]] call _addToUniform;
		[[_smokegrenadeB,3],[_grenademini,2],[_rifle_mag_tr,2]] call _addToVest;
	...
	case "ftl": {
		...
		_IFAK call _addToUniform;
		[[_pistol_mag,2],[_smokegrenadeY,4]] call _addToUniform;
		[[_smokegrenadeB,3],[_grenademini,2],[_grenade,2],[_rifleGL_mag_tr,4]] call _addToVest;
	...
	case "g": {
		...
		[[_glHE,7],[_glsmokeR,3],[_glsmokeY,3],[_clacker,1],[_demoCharge,2]] call _addToBackpack;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
			[[_mapFlashLight,1],[_IRStrobe,1]] call _addToUniform;
	...
	case "ag": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_smokegrenadeY,4],[_grenademini,2]] call _addToUniform;
		[[_pistol_mag,2],[_flashBang,3],[_rifle_mag,3],[_rifle_mag_tr,3]] call _addToVest;
	...
	case "lr": {
		...
		_IFAK call _addToUniform;
		[[_pistol_mag,2],[_smokegrenadeY,3]] call _addToUniform;
		[[_clacker,1],[_demoCharge,3]] call _addToBackpack;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
			[[_mapFlashLight,1],[_handFlareG,1],[_handFlareR,1]] call _addToUniform;
	...
	case "ab": {
		...
		_IFAK call _addToUniform;
		[[_pistol_mag,2],[_smokegrenadeY,3]] call _addToUniform;
		[[_rifleGL_mag_tr,6],[_rifle_mag_tr,6],[_LMG_mag_tr,2],[_rifleL_mag_tr,6],[_clacker,1],[_demoCharge,1]] call _addToBackpack;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
			[[_mapFlashLight,1],[_handFlareG,1],[_handFlareR,1]] call _addToUniform;
	...
	case "mat": {
		...
		[[_MAT_mag,1],[_defusalKit,1]] call _addToBackpack;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
			[[_mapFlashLight,1],[_handFlareG,1],[_handFlareR,1]] call _addToUniform;
	...
	case "amat": {
		...
		_IFAK call _addToUniform;
		[[_pistol_mag,2],[_smokegrenadeY,3]] call _addToUniform;
		[[_grenademini,2],[_grenade,2],[_rifle_mag_tr,6],[_glHE,6],[_glsmokeR,3]] call _addToVest;
		[[_MAT_mag,2],[_demoCharge,1],[_clacker,1]] call _addToBackpack;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
	...
	case "marksman": {
		...
		[[_rifleMarksman_mag,3],[_grenademini,2],[_smokegrenadeY,6],[_smokegrenadeB,6],[_smokegrenadeB,2],[_smokegrenadeP,2]] call _addToVest;
