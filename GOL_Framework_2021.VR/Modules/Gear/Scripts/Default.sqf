...
switch (toLower(_role)) do {
	...
	case "officer": {
		...
		[[_gps,1],[_pistol_mag,2],[_smokegrenadeY,3],[_rifle_mag,3]] call _addToUniform;
	...
	case "fac": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_gps,1],[_pistol_mag,2],[_grenade,2],[_smokegrenadeY,6]] call _addToUniform;
	...
	case "sl": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_gps,1],[_grenade,2],[_flashBang,2],[_pistol_mag,2],[_smokegrenadeY,4],[_smokegrenadeB,3]] call _addToUniform;
	...
	case "ftl": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_gps,1],[_flashBang,3],[_smokegrenadeB,3],[_pistol_mag,2],[_smokegrenadeY,4]] call _addToUniform;
	...
	case "mat": {
		...
		[[_MAT_mag,2],[_MAT_mag_HE,2],[_defusalKit,1],[_demoCharge,1],[_clacker,1]] call _addToBackpack;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
	...
	case "amat": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_grenade,4],[_pistol_mag,2],[_smokegrenadeY,3]] call _addToUniform;
		[[_rifle_mag_tr,6],[_glHE,6],[_glsmokeR,3]] call _addToVest;
