...
_helmet = ["acp_gol_CZ_vz95_H_HelmetB_light_CZ_vz95_insignia"] call BIS_fnc_selectRandom;
_OfficerHelmet = "rhsgref_fieldcap_ttsko_digi";
_uniform = selectRandom ["acp_gol_CZ_vz95_U_I_E_Uniform_shortsleeve_CZ_vz95_01_F_flag","acp_gol_CZ_vz95_U_I_E_Uniform_CZ_vz95_01_F_insignia"];
_vest = selectRandom["acp_gol_CZ_vz95_V_PlateCarrierIA2_CZ_vz95"];
