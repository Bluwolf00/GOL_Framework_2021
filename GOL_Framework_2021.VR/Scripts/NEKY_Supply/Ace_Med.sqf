if (hasInterface) then {
	...
	_landcode =
	{
		...
		[Side Player, systemChat "Pilot: Awaiting coordinates"] onMapSingleClick
		{
			...
			[(_This select 0),"","unload", ["helicopter_spawn",_pos,"helicopter_despawn"],_BoxCode,true] execVM "Scripts\NEKY_supply\NEKY_SupplyMapClick.sqf"; //true false = heli damage setting
		};
	};
	// NEKY EDIT END
