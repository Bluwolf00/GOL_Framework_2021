if (hasInterface) then {
	...
	_code =
	{
		...
		[_Side, systemChat "Pilot: Awaiting coordinates"] onMapSingleClick
		{
			...
			{
				Case WEST: {_BoxCode = {[_Box, "small_box","west"] call GW_Gear_Fnc_Handler; [_Box] ExecVM "Scripts\NEKY_ServiceStation\MobileSS.sqf";}};
				Case EAST: {_BoxCode = {[_Box, "small_box","east"] call GW_Gear_Fnc_Handler; [_Box] ExecVM "Scripts\NEKY_ServiceStation\MobileSS.sqf"; }};
				Case INDEPENDENT: {_BoxCode = {[_Box, "small_box","indep"] call GW_Gear_Fnc_Handler; [_Box] ExecVM "Scripts\NEKY_ServiceStation\MobileSS.sqf";}};
			};
	...
	_landcode =
	{
		...
		[_Side, systemChat "Pilot: Awaiting coordinates"] onMapSingleClick
		{
			...
			Switch (_This select 0) do
			{
				Case WEST: {_BoxCode = {[_Box, "small_box","west"] call GW_Gear_Fnc_Handler}};
				Case EAST: {_BoxCode = {[_Box, "small_box","east"] call GW_Gear_Fnc_Handler}};
				Case INDEPENDENT: {_BoxCode = {[_Box, "small_box","indep"] call GW_Gear_Fnc_Handler}};
			};
