...
// OKS_Helicopter_Patrol = compile preprocessFileLineNumbers "Scripts\NEKY_AirDrop\OKS_Helicopter_Patrol.sqf"; - Check Additional Script folder in Framework Main folder.