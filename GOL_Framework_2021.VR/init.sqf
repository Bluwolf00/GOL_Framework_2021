...
/* Neky ShareInfo Script for AI Uncomment below to activate	and add the code below to the bottom */
...
/*-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
	...
	// UnComment if you want to enable the use of Neky_HuntBase / AirBase (Remove the /* and */)
	/*
...
/*-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
	...
	/* Use this if you want AAC to be able to switch seats in their helicopters and get better doorgunners - Uncomment if you want to activate this */
	//[] execVM "Scripts\OKS_AAC\Init.sqf";

	/* Use the code below if you want the automatic hunt code, this takes all moving units and makes them attack the player if they are within range */
	/*
